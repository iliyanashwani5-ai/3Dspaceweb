...
Purpose:
This project illustrates the use of 3D graphics on the web and explores how visual interaction can shape their own experience. It can also be an example for the users to build more advanced and creative 3D games.
